...
🔹 **Full-Stack Developer | Backend Focus | AI Explorer**  
🔹 **热爱技术探索，正在走向工程化与系统化成长**

---

## 📌 关于我

👨‍💻 我是一名想要努力成长中的开发者，目前主要专注于 **后端开发 + 全栈能力提升**    
...
🔹 一个面向学生与家教老师的 **在线匹配与管理平台**  
🔹 提供从发布需求到匹配教师、沟通与管理的一体化服务  

💡 技术方向：

- Spring Boot + Vue 前后端分离架构
- JWT 用户认证与权限控制（学生 / 教师）
- Redis 缓存热点数据（教师列表 / 推荐）
- MySQL 存储用户、订单与匹配关系
- RabbitMQ（可选）处理异步通知 / 任务
...
- 🤖 **AI 技术方向**：  
  学习 LLM 应用开发，关注 AI 在实际系统中的落地能力

- 📈 **投资与基金**：  
  了解基础金融知识，建立长期投资认知与风险意识

- 📷 **摄影**：  
  作为长期兴趣方向，提升构图、光影与后期处理能力

- 📊 **运营思维**：  
  学习产品运营与增长逻辑，关注用户行为、数据分析与内容传播
